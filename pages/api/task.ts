...
const login = async (req: NextApiRequest, res: NextApiResponse<DefaultMessageResponse | object>) => {
  try {
    ...
    res.status(500).json({ error: "Ocorreu um erro ao utilizar tarefa, tente novamente." });
  }
};
